...
or send them via your own integration instead of the default one provided by
Meteor or want to do something else with the data. This is especially useful
if you want to intercept emails send by core packages like accounts-password
